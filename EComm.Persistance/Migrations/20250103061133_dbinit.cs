    ...
    public partial class dbinit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderProOrderId = table.Column<int>(type: "int", nullable: false),
                    ProductsProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderEntityProductEntity", x => new { x.OrderProOrderId, x.ProductsProductId });
                    table.ForeignKey(
                        name: "FK_OrderEntityProductEntity_Orders_OrderProOrderId",
                        column: x => x.OrderProOrderId,
